...
namespace TravelNotes
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\klas9\Desktop\人生計畫Excel\大專題\code\data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"col0", @"col0", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=5,MinimumExampleCountPerLeaf=41,NumberOfTrees=4,MaximumBinCountPerFeature=414,FeatureFraction=0.8351226154193,LearningRate=0.0243753446265418,LabelColumnName=@"col5",FeatureColumnName=@"Features"}),labelColumnName: @"col5"))      
