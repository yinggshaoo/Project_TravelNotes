...
{
    public partial class TravelML
    {
        public const string RetrainFilePath =  @"C:\Users\klas9\Desktop\TravelNotes\TravelNotes\TravelNotes\data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"col0", @"col0", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=10,NumberOfTrees=12,MaximumBinCountPerFeature=103,FeatureFraction=0.99999999,LearningRate=0.0378661068480503,LabelColumnName=@"col5",FeatureColumnName=@"Features"}),labelColumnName: @"col5"))      
