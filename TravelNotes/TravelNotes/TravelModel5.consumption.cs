...
namespace TravelNotes
{
    ...
    {
        /// <summary>
        /// model input class for TravelModel5.
        /// </summary>
        ...
        /// <summary>
        /// model output class for TravelModel5.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("TravelModel5.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("col5");
            if (labelColumn == null)
            {
                throw new Exception("col5 column not found. Make sure the name searched for matches the name in the schema.");
            }
