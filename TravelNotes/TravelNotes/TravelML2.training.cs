...
{
    public partial class TravelML2
    {
        public const string RetrainFilePath =  @"C:\Users\klas9\Desktop\人生計畫Excel\大專題\code\data3.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"col0", @"col0", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.7849643F,L2Regularization=0.03125F,LabelColumnName=@"col5",FeatureColumnName=@"Features"}))      
